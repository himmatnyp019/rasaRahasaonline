  ...
  return (
     ...
     <div className="bottom-navigation">
          <ul>
            ...
            {token
            ?<li> <Link className='Link-class' to='/Profile' onClick={()=> setActive("profile")} > <img src={assets.profile_tomato} alt="" /> <p className={`nav-index-text ${active==="profile"?"active":""}`} > Profile</p>  </Link> </li>
            :  <li> <Link className='Link-class'  onClick={handleLoginClick} > <img src={assets.profile_tomato} alt="" /> <p className={`nav-index-text ${active==="profile"?"active":""}`} > Login</p>  </Link> </li>
