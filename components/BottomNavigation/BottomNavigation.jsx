    ...
    <div className='bottom-nav-background'>
      ...
      <div className="bottom-navigation">
        <ul>
          ...
          <li> <Link className='Link-class' onClick={() => setActive("search")} to='/search'>  <img src={assets.search_tomato} alt="" /> <p className={`nav-index-text ${active === "search" ? "active" : ""}`}>Search</p> </Link>  </li>
