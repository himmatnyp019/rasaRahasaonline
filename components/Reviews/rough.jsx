...
if (!historyItemsId) {
  loadOrderHistory(localStorage.getItem("token"))
}
  ...
  const handleDelete = async () => {
    ...
    try {
      ...
      if (localStorage.getItem("token")) {
        const res = await axios.post(url + "/api/review/delete", {
        ...
        if (res.data.success) {
          ...
          loadReviewData(localStorage.getItem("token"));
          setText("");
          setRating(0);
          setHoverRating(0);
          navigate("/Details");
          ...
          toast.error("Error deleting review. Please refresh and try again.")
        }
        ...
        isOKForReview && (
          <div data-aos="fade-left" className="rb-card">
            ...
            <div className="rb-textarea">
              ...
              {imgPreview ? (
                <img className="rb-image" src={isOwnReview ? ownReview.image : imgPreview} alt="no-image" />
              ) : (
              ...
              <div className="rb-post">
                {isOwnReview && (
                  <button onClick={() => handleDelete(ownReviewId)}> Delete review</button>
                )}
