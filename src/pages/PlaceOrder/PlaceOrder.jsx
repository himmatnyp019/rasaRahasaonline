  ...
  return (
    <form className='place-order' >
      <div className="place-order-title">
        <h2 className='title-text'>{t("orderConfirmation")}</h2>
        <p>{t("orderDetails")}</p>
      </div>
      {/* info gathering */}
      <div className="place-order-left">
        <div className="order-info-contact">
          <p data-aos="fade-right" className='title'>{t("deliveryInformation")}</p>
          <p data-aos="fade-right" data-aos-delay="100" className='text-notice'>{t("deliveryUpdates")}</p>
          ...
          <div className="active-address-this">
            <h4 data-aos="fade-right">{t("yourDefaultDeliveryAddress")} :</h4>

            {activeAddress
              ? <div data-aos="fade-down" data-aos-delay="100" className='active-address-box'>
                <h4>{activeAddress}</h4>
                <Link className='change-default-address' to="/Profile"><u> {t("changeDefaultAddress")} </u> </Link>
              </div>
              : <div data-aos="fade-down" data-aos-delay="100" className='active-address-box'>
                <h4>{t("addressNotFound")}</h4>
                <Link className='change-default-address' to="/Profile"><u> {t("clickToAddAddress")} </u> </Link>
              </div>
            }
          </div>
        </div>
        ...
        <div className="payment-method-container">
          <br />
          <h3 data-aos="fade-right" data-aos-delay="100" >{t("selectPaymentMethod")}</h3>
          <p data-aos="fade-right" >{t("paymentInfoIsSafe")}</p>
          ...
          <div data-aos="fade-right" className="payment-options-container">
            <div onClick={() => paymentMethodHandler(1, "Pay with Kakao Pay")} className={`payment-option-box ${checked === 1 ? "checked" : ""}`}> <div className="img-warper"><img src={assets.kakao_pay} alt="icons" /></div> <p>{t("payWithKakaoPay")}</p> <img className={`checkbox ${checked === 1 ? "checked" : ""}`} src={assets.checkbox} alt="" /></div>
            <div onClick={() => paymentMethodHandler(2, "Pay with credit / debit Card")} className={`payment-option-box ${checked === 2 ? "checked" : ""}`}> <div className="img-warper"><img src={assets.card_pay} alt="icons" /></div><p>{t("payWithCard")}</p> <img className={`checkbox ${checked === 2 ? "checked" : ""}`} src={assets.checkbox} alt="" /> </div>
            <div onClick={() => paymentMethodHandler(3, "Pay in Cash")} className={`payment-option-box ${checked === 3 ? "checked" : ""}`}> <div className="img-warper"><img src={assets.cash_pay} alt="icons" /></div> <p>{t("payInCash")}</p> <img className={`checkbox ${checked === 3 ? "checked" : ""}`} src={assets.checkbox} alt="" /> </div>
          </div>
      ...
      <div className="place-order-right">
        <div className="order-final-container">
          ...
          <div className="cart-items-quick">
            <h2>{t("quickViewItems")}</h2>
            <p>{t("quickViewProcessing")}</p>
          ...
          <div data-aos="fade-left" data-aos-delay="100" className="cart-total-1">
            ...
            <div>
              ...
              <div className="cart-total-details">
                <p className='price-tag-text'>{t("total")}</p>
                <p className='bill-count'>₩{amountBeforeDiscount}</p>
              </div>
              <hr />
              <div className="cart-total-details">
                <p className='price-tag-text'>{t("discount")}</p>
              ...
              <hr />
              <div className="cart-total-details">
                <p className='price-tag-text'>{t("finalPrice")}</p>
                <p className='bill-count'>₩{totalAmount}</p>
              </div>
              <hr />
              <div className="cart-total-details">
                <p className='price-tag-text'>{t("formDeliveryCharge")}</p>
